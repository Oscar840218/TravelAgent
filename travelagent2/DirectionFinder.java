...
public class DirectionFinder{
    ...
    private static final String GOOGLE_API_KEY = "AIzaSyB7R9--U4Dx_7hpLLMWUBzOlO5CQeZ_N9A";
    private DirectionFinderListener listener;
    private String start,end;

    public  DirectionFinder(DirectionFinderListener listener,String start,String end){
    ...
    public void execute() throws UnsupportedEncodingException {
        ...
        new DataDownload().execute(createUrl());
    }
